...
Build an AI agent with the Strands Agents SDK that handles repetitive tasks.

- **Who can participate:** People above the age of majority in their country of residence.
- **Rules:** See the [Official Rules](#official-rules).

### At a Glance

- **Deadline:** September 14, 2026, at 5:00 p.m. PDT
- **Format:** Online and public
- **Prize pool:** $40,000 in cash
- **Managed by:** Devpost
- **Categories:** Beginner-friendly, machine learning/AI, open-ended
...
- 🌐 Build with the open-source, production-ready Strands Agents SDK.
- 🛠️ Solve real problems people deal with, from daily chores to professional workloads and community logistics.
- 💳 Get $50 in AWS credits to cover build costs.
- 🌍 Participate worldwide, solo or as a team, whether new or experienced.
- 📝 Earn bonus points by publishing your build story on [builder.aws.com](https://builder.aws.com/).
...
An agent that takes the busywork out of daily life, home, money, health, errands, and family tasks. The best ones run quietly in the background and only ping you when there is a real decision to make.

#### Professional Agents

An agent that makes someone dramatically better at work they already do, including work by professionals, makers, creators, and small-business owners. Target repetitive, judgment-heavy tasks that consume their day.

#### Good Neighbor Agents

An agent that helps groups of people, not just one person: neighborhoods, nonprofits, food banks, schools, libraries, and small local organizations.
...
- **Public repository URL:** Include a public URL to your code repository.
- **Source code, assets, and setup instructions:** Include everything needed to run the project.
- **MIT or Apache license:** Make it visible in the repository's About section.
- **README**
- **Architecture diagram**
- **Demo video:** Maximum five minutes, demonstrating the working project.
- **Pitch:** Cover the problem, audience, and why the project matters.
- **AWS Builder ID**
- **Optional live demo link:** Projects with a live demo score higher in Technical Implementation.

Slides, screen recordings, and voiceover are all acceptable; you do not need to appear on camera.

 

> **⭐ Bonus points:** Publish a post on [builder.aws.com](https://builder.aws.com/) covering your build journey and use of AWS for this hackathon. Use “Agents for Humans” in your title. Posts must be public before the submission deadline.
...
Sandhya Subramani
Sandhya Subramani
Sr. Dev Advocate, GenAI at AWS

Ian Holtz
Ian Holtz
Sr. GTM Specialist Agentic Coding at AWS

Gonzalo Ron
Gonzalo Ron
Principal Partner Solution Architect at AWS

Ifeanyi Otuonye
Ifeanyi Otuonye
Technical Content Creator at AWS

Sunil Divvela
Sunil Divvela
Sr. WW Spec Solution Architect, Mainframe at AWS
...
Create your AWS Account  Sign up for a free AWS Account →
Install the Strands Agents SDK Available in Python and TypeScript. You can have a working agent running in under 20 minutes.
Strands Agents Quickstart (Python & TypeScript) →

Strands Agents Examples →

Request your AWS Credits Registered participants can request $50 in AWS Promotional Credits to cover build costs, while supplies last. Requests must be submitted by September 11, 2026 at 12pm PT. Subject to AWS Promotional Credits terms.
 

## 📖 Learning Resources
New to Strands or agentic AI? Start here:

Getting Started with Strands Agents: Step-by-Step Guide — Beginner walkthrough from AWS, zero to working agent

Strands Agents SDK: Technical Deep Dive — Architecture patterns and observability for seasoned builders

Introducing Strands Agents (AWS Open Source Blog) — How it works and why it was built

 Strands Agents Playlist 14 free videos
...
AgentCore Quickstart (CLI) →

Deploy a Strands Agent to AgentCore Runtime →

 

## Inspiration
Not sure where to start? Read through these; the best project ideas usually start with a question, not an answer.
