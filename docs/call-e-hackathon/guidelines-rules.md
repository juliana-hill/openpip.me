...
Turn your code into an AI agent that makes real phone calls.

### At a Glance

- **Deadline:** September 14, 2026, at 11:45 a.m. SGT
- **Format:** Online and public
- **Prize pool:** $10,000 in cash
- **Managed by / Sponsor:** AIRUDDER Pte Ltd
- **Categories:** Communication, Machine Learning/AI
- **Who can participate:** People above the age of majority in their country of residence. All countries/territories, excluding standard exceptions.

CALL-E is a developer-first platform for building AI agents that make real phone calls and get real-world tasks done. Instead of stopping at text, your agents can plan a call, dial out, hold a natural conversation, adapt in real time, and return structured results you can act on — all through CALL-E's SDK, API, and MCP. In other words: your agents can finally pick up the phone (and actually get something done while they're on the line). ☎️
...
- 📞 **Build something real.** Ship an AI agent that completes actual tasks over the phone — not a demo that just generates text.
- 🚀 **Work with a new platform first.** Get hands-on early with CALL-E's SDK, API, MCP, CLI, or SKILL, and help shape what it becomes.
- 🐛 **Shape the roadmap.** Your feedback and bug reports go straight to the CALL-E team, with prizes for the most useful input.
- 💰 **Compete for $10,000 in cash prizes,** plus meetings with the CALL-E team, blog features, and CALL-E credits.

## Get Started

1. Install CALL-E and sign in (5 min) by following the installation guide. You'll get a CALL-E account with 20 free calls automatically. Need more? Request additional calls via [this form](https://forms.gle/).
2. Connect it to your agent via MCP, SDK, API, CLI, or SKILL using the integration guide (~30 min).
3. Browse example skills and apps and brainstorm your build (30 minutes).
...
All new CALL-E accounts come with 20 free CALL-E calls. Running out while building your project? Request additional calls via the form above.

### What to Submit

- Open a pull request to CALL-E's public repository at [CALLE-AI/awesome-phone-call-agents](https://github.com/CALLE-AI/awesome-phone-call-agents).
- Follow the instructions under the repo's README to submit your pull request to the correct Contribution Area (e.g. "Agent Skills," "Workflow Plugins").
...
- **Optional:** Provide a URL to your functional demo application.
- **Optional:** Submit the [CALL-E Feedback Survey](#) — eligible for one of five Most Valuable Feedback prizes.

> **Two repositories, two jobs — don't mix them up:**
> - 🔧 Setting up CALL-E? → [CALL-E Integrations](https://github.com/CALLE-AI/call-e-integrations)
> - 📤 Submitting your project? → [Awesome Phone Call Agents](https://github.com/CALLE-AI/awesome-phone-call-agents)
...
- [CALL-E Integrations (GitHub)](https://github.com/CALLE-AI/call-e-integrations) — install guide, MCP / SDK / API / CLI / SKILL quickstarts, and runnable examples
- CALL-E Documentation — SDKs and API Reference
- Install / setup guide and troubleshooting
- [heycall-e.com](https://heycall-e.com) — product overview

## Inspiration

- [Awesome Phone Call Agents (GitHub)](https://github.com/CALLE-AI/awesome-phone-call-agents) — reusable skills, apps, and workflow patterns to spark ideas
- Reference skills:
  - `call-reminder` (scheduled reminders)
  - `google-form-callback` (callbacks from form responses)
  - `outbound-call-skill-creator` (build a custom outbound workflow)
- Example use cases: customer outreach, appointment confirmation, lead qualification, order/exception follow-up, service dispatch, incident escalation
- Runnable apps & plugins: Python batch runner, n8n CALL-E workflow template
...
Reach out for technical support in the CALL-E Discord community.
...
- **Submission Period:** July 23, 2026 (9:30 pm SGT) – September 14, 2026 (11:45 am SGT)
- **Feedback Period:** July 23, 2026 (9:30 pm SGT) – September 18, 2026 (11:45 pm SGT)
...
Entrants may enter by visiting [call-e.devpost.com](https://call-e.devpost.com) ("Hackathon Website") and following the below steps:
...
1. **Real World Impact** — Does the project identify a real, specific phone-work problem and make a credible case that it solves it for real users? A strong project points to a direction worth building further for real users after the hackathon — not a generic "AI that makes phone calls" concept.
2. **Quality of the Idea** — Is this a creative, non-obvious use of CALL-E that shows genuine understanding of the problem space? Is the contribution (skill, app, plugin, or demo) clear, well-scoped, and reusable by the community?
3. **Technical Implementation** — How thoroughly and skillfully does the project use CALL-E? Does the code reflect genuine effort and a working, non-trivial implementation — CALL-E imported and actually called at runtime, not just referenced?
4. **Product Experience & Demo** — Does the project deliver a complete, coherent experience, and does the demo video clearly communicate what it does and why it matters?
...
|---|---|---|---|
| Most Practical Use Case | $4,000 USD + virtual meeting with the CALL-E team + blog post feature + 20,000 CALL-E credits (~$200 USD) | 1 | All eligible submissions |
| Most Innovative Use Case | $3,000 USD + virtual meeting with the CALL-E team + blog post feature + 20,000 CALL-E credits (~$200 USD) | 1 | All eligible submissions |
| Honorable Mention | $1,000 USD + virtual meeting with the CALL-E team + blog post feature + 10,000 CALL-E credits (~$100 USD) | 2 | All eligible submissions |
| Most Valuable Feedback | $200 USD + 10,000 CALL-E credits (~$100 USD) | 5 | All eligible Feedback submissions |
