...
function productionCreate(_, jsx20, jsxs15) {
  return create2;
  function create2(_2, type, props, key) {
    const isStaticChildren = Array.isArray(props.children);
    const fn = isStaticChildren ? jsxs15 : jsx20;
...
function setFavicon(icon) {
  ...
  let link3 = document.querySelector("link[rel~='icon']");
  if (!link3) {
...
function notifyAgentIdentityChanged(name2, icon) {
  if (name2 !== void 0) cachedName = name2 || DEFAULT_NAME;
  if (icon !== void 0) cachedIcon = icon;
  if (typeof document !== "undefined") {
    if (name2 !== void 0) document.title = cachedName;
    if (icon !== void 0) setFavicon(cachedIcon);
  }
  notify();
}
...
function Image2(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("img", { ...imgProps });
}

// components/app-header.module.css
var app_header_default = {
  header: "app_header_header",
  inner: "app_header_inner",
  avatarLink: "app_header_avatarLink",
  avatar: "app_header_avatar",
  avatarImg: "app_header_avatarImg",
...
function AppHeader({ userImage, userName, initials, backHref, backLabel }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("header", { className: app_header_default.header, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: app_header_default.inner, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: app_header_default.left, children: [
      backHref && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Link, { href: backHref, className: app_header_default.backLink, children: [
        "\u2190 ",
        backLabel ?? "Back"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: app_header_default.date, children: today })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Link, { href: "/", className: app_header_default.logoLink, children: [
      agentIcon ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("img", { src: agentIcon, alt: agentName, width: 32, height: 32, className: app_header_default.logoImg }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { src: "/trippy-transparent.png", alt: agentName, width: 32, height: 32, className: app_header_default.logoImg }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: app_header_default.wordmark, children: agentName })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link, { href: "/settings", className: app_header_default.avatarLink, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: app_header_default.avatar, children: userImage ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("img", { src: userImage, alt: userName, referrerPolicy: "no-referrer", className: app_header_default.avatarImg }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: initials }) }) })
  ] }) });
}
...
var PocketTTS = class {
   ...
   * @returns {Promise<string>} A voice reference usable in generate().
   */
  async loadVoice(name2) {
    const { ref } = await this._request("loadBuiltinVoice", { name: name2 });
    return ref;
  }
  /**
   ...
   */
  async generate(text7, opts = {}) {
    if (!opts.voice) throw new Error("generate() requires a `voice` reference.");
    this._onChunk = opts.onChunk || null;
    try {
      const { metrics } = await this._request("generate", { text: text7, voiceRef: opts.voice });
      return metrics;
    } finally {
      this._onChunk = null;
    }
...
function humanizeFieldLabel(rawKey) {
  ...
  return words.map((word, index2) => index2 === 0 ? word[0].toUpperCase() + word.slice(1) : word).join(" ");
}
function insertFieldPauses(text7) {
  return text7.replace(FIELD_LABEL, (_match, rawKey) => `
${humanizeFieldLabel(rawKey)}.
`);
}
function expandNumbers(text7) {
  return text7.replace(/\$(\d[\d,]*)\.00\b/g, "$1 dollars").replace(/\$(\d[\d,]*)\.(\d{2})\b/g, "$1 dollars $2 cents").replace(/\$(\d[\d,]*)/g, "$1 dollars").replace(/(\d)\.(\d)/g, "$1 point $2").replace(/\s*\/\s*(month|mo|week|wk|night|day|yr|year)\b/gi, " per $1");
}
...
function phraseForSynthesis(text7) {
  const expanded = ABBREVIATIONS.reduce((acc, [pattern, replacement]) => acc.replace(pattern, replacement), text7);
  const sentences = [];
...
async function getEngine(onProgress) {
  ...
  enginePromise = (async () => {
    ...
    try {
      ...
      const name2 = available.includes(PREFERRED_VOICE) ? PREFERRED_VOICE : available[0];
      if (!name2) throw new Error("The voice bundle contains no predefined voices.");
      engine = { tts, voice: await tts.loadVoice(name2) };
      return engine;
    } catch (error) {
      tts.destroy();
      enginePromise = null;
...
async function speakNaturally(text7, callbacks = {}) {
  if (typeof window === "undefined") return false;
  const spoken = speakableText(insertFieldPauses(text7));
...
function setActiveButton(activeId) {
  ...
  listeners2.forEach((listener) => listener(activeId));
}
function stopReadAloud() {
  stopSpeaking();
  setActiveButton(null);
}
function ReadAloudButton({ text: text7, className, style, iconSize = 15 }) {
  const idRef = (0, import_react3.useRef)(null);
  if (idRef.current === null) idRef.current = nextButtonId++;
  const id = idRef.current;
  const [speaking, setSpeaking] = (0, import_react3.useState)(() => activeButtonId === id);
  ...
  const handleSpeak = (0, import_react3.useCallback)(() => {
    if (speaking) {
      stopReadAloud();
      return;
    }
    const readableText = text7.trim();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "button",
    {
      ...
      className,
      style,
      children: speaking ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(VolumeOff, { size: iconSize }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Volume2, { size: iconSize })
    }
  );
}
...
function LegContent({ leg }) {
  if (leg.isLayover) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.legHeader, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: RouteCard_default.legLabelLayover, children: [
        leg.isOvernightLayover ? "Overnight layover" : "Transfer",
        leg.layoverLocation ? ` at ${leg.layoverLocation}` : ""
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.legDurationLayover, children: leg.duration })
    ] }) });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.legHeader, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.legLabel, children: leg.label }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: RouteCard_default.legDuration, children: [
        leg.duration,
        showCost ? ` \xB7 ${leg.cost}` : ""
      ] })
    ] }),
    hasTimes && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.legTimes, children: leg.departureTime && leg.arrivalTime ? `${leg.departureTime} \u2192 ${leg.arrivalTime}` : leg.departureTime ?? leg.arrivalTime }),
    hasStops && !hasTimes && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: RouteCard_default.legStops, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(MapPin, { style: { display: "inline", width: 12, height: 12, marginRight: 2, verticalAlign: "-1px" } }),
      leg.from && leg.to ? `${leg.from} \u2192 ${leg.to}` : leg.from ?? leg.to
    ] }),
    (leg.headsign || leg.stopCount || leg.distanceLabel) && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.legMeta, children: [
      leg.headsign ? `toward ${leg.headsign}` : null,
      leg.stopCount ? `${leg.stopCount} stop${leg.stopCount !== 1 ? "s" : ""}` : null,
      leg.distanceLabel ?? null
    ].filter(Boolean).join(" \xB7 ") }),
    leg.links && leg.links.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.legLinks, children: leg.links.map((link3, j) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { href: link3.url, target: "_blank", rel: "noopener noreferrer", className: RouteCard_default.legLink, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ExternalLink, { style: { width: 12, height: 12, flexShrink: 0 } }),
      link3.title
    ] }, j)) }),
    (leg.agencyUri || leg.lineUri) && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.legAgencyLinks, children: [
      leg.lineUri && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { href: leg.lineUri, target: "_blank", rel: "noopener noreferrer", className: RouteCard_default.legAgencyLink, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ExternalLink, { style: { width: 10, height: 10, flexShrink: 0 } }),
        "Route info"
      ] }),
      leg.agencyUri && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { href: leg.agencyUri, target: "_blank", rel: "noopener noreferrer", className: RouteCard_default.legAgencyLink, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ExternalLink, { style: { width: 10, height: 10, flexShrink: 0 } }),
        "Agency website"
      ] })
    ] })
...
function RouteCard({ option, travelDate }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.card, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.cardBody, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.header, onClick: () => setCollapsed((c) => !c), children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.nameGroup, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.modeIcons, children: option.modes.map((mode, i) => {
          const Icon = modeIcons[mode];
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.modeIcon, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { style: { width: 20, height: 20 } }) }, `${mode}-${i}`);
        }) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { className: RouteCard_default.routeName, children: option.name }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.routeSubtitle, children: option.subtitle })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.stats, children: [
        showDateBadge && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.dateBadge, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.dateBadgeLabel, children: "Date" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.dateBadgeValue, children: formatTravelDate(routeDate) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.stat, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.statLabel, children: "Duration" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.statValue, children: displayDuration })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.stat, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.statLabel, children: "Price" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.priceValue, children: priceTotal }),
          priceBreakdown && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: RouteCard_default.priceBreakdown, children: priceBreakdown })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `${RouteCard_default.collapseGrid} ${collapsed ? RouteCard_default.closed : RouteCard_default.open}`, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.collapseInner, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.collapseContent, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.barRow, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.bar, children: option.legs.map((leg, i) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: `${RouteCard_default.workBadge} ${option.workableHours > 0 ? RouteCard_default.workBadgePositive : RouteCard_default.workBadgeNeutral}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Briefcase, { style: { display: "inline", width: 12, height: 12, marginRight: 4, verticalAlign: "-1px" } }),
          "Work: ",
          option.workableHours,
          "h"
        ] })
      ] }),
      option.calendarNote && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.calendarNote, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Calendar, { style: { width: 14, height: 14, marginTop: 2, flexShrink: 0 } }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: option.calendarNote })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RouteCard_default.legs, children: option.legs.map((leg, i) => {
        const isLast = i === option.legs.length - 1;
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.legRow, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RouteCard_default.legIconCol, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `${RouteCard_default.legIcon} ${leg.isLayover ? RouteCard_default.legIconLayover : RouteCard_default.legIconDefault}`, children: leg.isLayover ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Clock, { style: { width: 16, height: 16 } }) : (() => {
              const Icon = modeIcons[leg.mode];
              return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { style: { width: 16, height: 16 } });
            })() }),
            !isLast && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `${RouteCard_default.legConnector} ${leg.isLayover ? RouteCard_default.legConnectorLayover : RouteCard_default.legConnectorDefault}` })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `${RouteCard_default.legContent} ${isLast ? RouteCard_default.legContentLast : ""} ${leg.isLayover ? RouteCard_default.legContentLayover : RouteCard_default.legContentDefault}`, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(LegContent, { leg }) })
        ] }, i);
      }) })
    ] }) }) })
  ] }) });
...
function RouteComparisonCard({ result }) {
  if (!result?.routes?.length) {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: RouteComparisonCard_default.empty, children: "No routes found." });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: RouteComparisonCard_default.cards, children: sorted.map((route, i) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(RouteCard, { option: route }, i)) });
}
...
function formatTimeRange(start2, end) {
  if (!start2.includes("T")) {
    const dateStr2 = (/* @__PURE__ */ new Date(start2 + "T00:00:00")).toLocaleDateString(void 0, {
      weekday: "short",
      month: "short",
      day: "numeric"
    });
...
function groupByCalendar(events) {
  ...
  for (const event of events) {
    const name2 = event.calendarName;
    if (!grouped.has(name2)) {
      grouped.set(name2, []);
      colorMap.set(name2, CALENDAR_COLORS[colorMap.size % CALENDAR_COLORS.length]);
    }
    grouped.get(name2).push(event);
  }
  return Array.from(grouped.entries()).map(([name2, events2]) => ({
    name: name2,
    color: colorMap.get(name2),
    events: events2
  }));
}
function CalendarSummaryCard({ result }) {
  ...
  if (!events.length) {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: CalendarSummaryCard_default.empty, children: "No calendar events found." });
  }
  const calendars = groupByCalendar(events);
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: CalendarSummaryCard_default.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { display: "flex", justifyContent: "flex-end", marginBottom: 4 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ReadAloudButton, { text: speechText, style: { background: "none", border: "none", cursor: "pointer", color: "var(--color-text-muted)", padding: 4, display: "flex", alignItems: "center" }, iconSize: 14 }) }),
    calendars.map((cal, ci) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: CalendarSummaryCard_default.calHeader, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: CalendarSummaryCard_default.dot, style: { backgroundColor: cal.color } }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: CalendarSummaryCard_default.calName, children: cal.name }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: CalendarSummaryCard_default.count, children: [
          cal.events.length,
          " event",
          cal.events.length !== 1 ? "s" : ""
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: CalendarSummaryCard_default.events, children: cal.events.map((event, ei) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: CalendarSummaryCard_default.event, style: { borderLeftColor: cal.color }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: CalendarSummaryCard_default.eventTitle, children: event.title }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: CalendarSummaryCard_default.eventTime, children: formatTimeRange(event.start, event.end) })
      ] }, ei)) })
    ] }, ci))
  ] });
}
...
function TransportHubsCard({ result, location }) {
  ...
  if (!hubs) return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: TransportHubsCard_default.empty, children: "No transport hubs found." });
  const totalHubs = hubs.airports.length + hubs.trainStations.length + hubs.busStations.length + (hubs.busStops?.length ?? 0);
  if (totalHubs === 0) return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("p", { className: TransportHubsCard_default.empty, children: [
    "No transport hubs found near ",
    location,
    "."
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: TransportHubsCard_default.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: TransportHubsCard_default.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: TransportHubsCard_default.title, children: "Transport Hubs" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("p", { className: TransportHubsCard_default.subtitle, children: [
        "Near ",
        location
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: TransportHubsCard_default.body, children: hubSections.map(({ key, label, Icon }) => {
      const items = hubs[key] ?? [];
      if (items.length === 0) return null;
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: TransportHubsCard_default.section, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: TransportHubsCard_default.sectionHeader, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Icon, { size: 14, className: TransportHubsCard_default.sectionIcon }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: TransportHubsCard_default.sectionLabel, children: label })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: TransportHubsCard_default.grid, children: items.map((hub, i) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: TransportHubsCard_default.hub, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("p", { className: TransportHubsCard_default.hubName, children: [
            hub.name,
            hub.code && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: TransportHubsCard_default.hubCode, children: hub.code })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: TransportHubsCard_default.hubCity, children: hub.city })
        ] }, i)) })
      ] }, key);
    }) })
  ] });
...
function truncateSnippet(text7, maxLen = 200) {
  const cleaned = text7.replace(/Skip to content\n?/gi, "").replace(/Accessibility Feedback\n?/gi, "").replace(/\n{3,}/g, "\n\n").trim();
...
function WebSearchCard({ result, query, toolName }) {
  ...
  if (!Array.isArray(results) || results.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("p", { className: WebSearchCard_default.empty, children: [
      "No results found for \u201C",
      query,
      "\u201D"
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: WebSearchCard_default.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: WebSearchCard_default.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Search, { size: 14, className: WebSearchCard_default.searchIcon }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: WebSearchCard_default.title, children: "Web Search" }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: WebSearchCard_default.count, children: [
        results.length,
        " result",
        results.length !== 1 ? "s" : ""
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: WebSearchCard_default.queryRow, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: WebSearchCard_default.query, children: query }) }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: WebSearchCard_default.results, children: results.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      "a",
      {
        href: r.url,
        target: "_blank",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ExternalLink, { size: 14, className: WebSearchCard_default.externalIcon }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: WebSearchCard_default.resultBody, children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: WebSearchCard_default.resultTitle, children: r.title }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: WebSearchCard_default.resultDomain, children: extractDomain(r.url) }),
            r.snippet && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: WebSearchCard_default.resultSnippet, children: truncateSnippet(r.snippet) })
          ] })
        ]
      },
      i
...
function CollapsibleToolCard({ icon, title, subtitle, defaultExpanded = false, children }) {
  const [expanded, setExpanded] = (0, import_react5.useState)(defaultExpanded);
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: CollapsibleToolCard_default.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
      "div",
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: CollapsibleToolCard_default.icon, children: icon }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: CollapsibleToolCard_default.title, children: title }),
          subtitle && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: CollapsibleToolCard_default.subtitle, children: subtitle }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ChevronRight, { size: 14, className: `${CollapsibleToolCard_default.chevron} ${expanded ? CollapsibleToolCard_default.chevronOpen : ""}` })
        ]
      }
    ),
    expanded && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: CollapsibleToolCard_default.body, children })
  ] });
}
...
function TaskRow({ task }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: TaskCard_default.row, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: TaskCard_default.left, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: TaskCard_default.topLine, children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: `${TaskCard_default.sourceBadge} ${TaskCard_default[`source_${source}`]}`, children: "Google Tasks" }),
        task.identifier && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: TaskCard_default.identifier, children: task.identifier }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: TaskCard_default.title, children: title })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: TaskCard_default.bottomLine, children: [
        task.project && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: TaskCard_default.project, children: task.project }),
        duration && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: TaskCard_default.chip, children: duration }),
        scheduled && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: TaskCard_default.scheduled, children: scheduled })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: TaskCard_default.right, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: TaskCard_default.status, children: status }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: `${TaskCard_default.priorityBadge} ${TaskCard_default[`priority_${priority}`]}`, children: priority })
    ] })
  ] });
}
function TaskCard({ result, toolName: _toolName }) {
  if (!result) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: TaskCard_default.empty, children: "No tasks found." });
  let tasks = null;
  try {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: TaskCard_default.empty, children: result });
  }
  if (!tasks || tasks.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: TaskCard_default.empty, children: "No tasks found." });
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: TaskCard_default.list, children: tasks.map((task, i) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(TaskRow, { task }, task.id ?? i)) });
}
...
function formatRange(start2, end) {
...
function CalendarEventProposalCard({ args }) {
  const [state, setState] = (0, import_react6.useState)("pending");
  const [loading, setLoading] = (0, import_react6.useState)(false);
  const [error, setError] = (0, import_react6.useState)(null);
  if (state === "dismissed") return null;
  if (state === "accepted") {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: CalendarEventProposalCard_default.accepted, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(CircleCheckBig, { size: 16 }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: args.title }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: CalendarEventProposalCard_default.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: CalendarEventProposalCard_default.titleRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Calendar, { size: 14, className: CalendarEventProposalCard_default.calIcon }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: CalendarEventProposalCard_default.eventTitle, children: args.title })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: CalendarEventProposalCard_default.timeRange, children: formatRange(args.start, args.end) }),
    args.location && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: CalendarEventProposalCard_default.locationRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(MapPin, { size: 12, className: CalendarEventProposalCard_default.pinIcon }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: CalendarEventProposalCard_default.location, children: args.location })
    ] }),
    error && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: CalendarEventProposalCard_default.error, children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: CalendarEventProposalCard_default.actions, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { className: CalendarEventProposalCard_default.acceptBtn, onClick: handleAccept, disabled: loading, children: loading ? "Adding\u2026" : "Add to Calendar" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        "button",
        {
          ...
          disabled: loading,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(X, { size: 12 }),
            "Dismiss"
          ]
        }
      )
...
function DropdownMenu({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(DropdownContext.Provider, { value: { open, setOpen }, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { ref, style: { position: "relative", display: "inline-block" }, children }) });
}
function DropdownMenuTrigger({ children, asChild, ...props }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", onClick: () => setOpen(!open), ...props, children });
}
...
function ComposerPlusMenu({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(DropdownMenu, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(DropdownMenuTrigger, { suppressHydrationWarning: true, className: ComposerPlusMenu_default.trigger, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Plus, { size: 18 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(DropdownMenuContent, { align: "start", side: "top", className: ComposerPlusMenu_default.menu, children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(DropdownMenuItem, { className: ComposerPlusMenu_default.item, onClick: onSelectCalendarEvent, children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Calendar, { size: 15, className: ComposerPlusMenu_default.itemIcon }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: ComposerPlusMenu_default.itemLabel, children: "Calendar Event" }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: ComposerPlusMenu_default.itemDesc, children: "Search your Google Calendar" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(DropdownMenuItem, { className: ComposerPlusMenu_default.item, onClick: onSelectSavedAddress, children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(MapPin, { size: 15, className: ComposerPlusMenu_default.itemIcon }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: ComposerPlusMenu_default.itemLabel, children: "Saved Address" }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: ComposerPlusMenu_default.itemDesc, children: "Attach a saved location" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(DropdownMenuItem, { className: ComposerPlusMenu_default.item, onClick: () => fileInputRef.current?.click(), children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FileUp, { size: 15, className: ComposerPlusMenu_default.itemIcon }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: ComposerPlusMenu_default.itemLabel, children: "Upload File" }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: ComposerPlusMenu_default.itemDesc, children: "Attach a PDF or image" })
          ] })
        ] })
      ] })
    ] })
...
function ContextChip({ chip, onRemove }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, background: "var(--color-accent-light)", borderRadius: 999, padding: "4px 10px", fontSize: "var(--font-size-xs)", color: "var(--color-accent)", whiteSpace: "nowrap", flexShrink: 0 }, children: [
    chip.kind === "event" ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Calendar, { style: { width: 12, height: 12, flexShrink: 0 } }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(MapPin, { style: { width: 12, height: 12, flexShrink: 0 } }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis" }, children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(X, { style: { width: 12, height: 12 } })
      }
    )
  ] });
}
...
function formatEventTime(start2, end) {
  const s = new Date(start2);
  const e = new Date(end);
  if (!start2.includes("T")) return "All day";
...
function CalendarEventPickerSheet({ open, onClose, onConfirm }) {
  ...
  const groups = (0, import_react8.useMemo)(() => groupEventsByDate(filtered), [filtered]);
  function toggle(id) {
    setSelectedIds((prev) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: CalendarEventPickerSheet_default.backdrop, onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: CalendarEventPickerSheet_default.modal, onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: CalendarEventPickerSheet_default.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("h2", { className: CalendarEventPickerSheet_default.title, children: "Add Calendar Events" }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("button", { type: "button", "aria-label": "Close", onClick: onClose, className: CalendarEventPickerSheet_default.closeBtn, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(X, { size: 16 }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: CalendarEventPickerSheet_default.searchRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Search, { size: 15, className: CalendarEventPickerSheet_default.searchIcon }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: CalendarEventPickerSheet_default.list, children: loading ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: CalendarEventPickerSheet_default.skeleton }, i)) }) : groups.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: CalendarEventPickerSheet_default.empty, children: "No events found" }) : groups.map((group) => /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: CalendarEventPickerSheet_default.group, children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: CalendarEventPickerSheet_default.groupLabel, children: group.label }),
      group.events.map((ev) => {
        const checked = selectedIds.has(ev.id);
        return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("label", { className: `${CalendarEventPickerSheet_default.eventRow} ${checked ? CalendarEventPickerSheet_default.eventRowChecked : ""}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: `${CalendarEventPickerSheet_default.checkbox} ${checked ? CalendarEventPickerSheet_default.checkboxChecked : ""}`, children: checked ? "\u2713" : "" }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: CalendarEventPickerSheet_default.calDot, style: { backgroundColor: ev.calendarColor } }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: CalendarEventPickerSheet_default.eventBody, children: [
            /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: CalendarEventPickerSheet_default.eventTitle, children: ev.title }),
            /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("p", { className: CalendarEventPickerSheet_default.eventMeta, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: CalendarEventPickerSheet_default.footer, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("button", { type: "button", onClick: handleConfirm, disabled: count === 0, className: CalendarEventPickerSheet_default.confirmBtn, children: [
      count === 0 ? "Select events" : `Add ${count} event${count === 1 ? "" : "s"}`,
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(ArrowRight, { size: 15 })
    ] }) })
  ] }) });
}
...
function SavedAddressPickerSheet({ open, onClose, onConfirm }) {
  ...
  if (!open) return null;
  const count = selectedIds.size;
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: SavedAddressPickerSheet_default.backdrop, onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: SavedAddressPickerSheet_default.modal, onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: SavedAddressPickerSheet_default.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("h2", { className: SavedAddressPickerSheet_default.title, children: "Add Saved Address" }),
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("button", { type: "button", "aria-label": "Close", onClick: onClose, className: SavedAddressPickerSheet_default.closeBtn, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(X, { size: 16 }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: SavedAddressPickerSheet_default.searchRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Search, { size: 15, className: SavedAddressPickerSheet_default.searchIcon }),
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("input", { value: query, onChange: (e) => setQuery(e.target.value), placeholder: "Search addresses\u2026", className: SavedAddressPickerSheet_default.searchInput })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: SavedAddressPickerSheet_default.list, children: loading ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_jsx_runtime18.Fragment, { children: [1, 2, 3].map((i) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: SavedAddressPickerSheet_default.skeleton }, i)) }) : filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: SavedAddressPickerSheet_default.empty, children: addresses.length === 0 ? "No saved addresses yet" : "No addresses match your search" }) : filtered.map((addr) => {
      const checked = selectedIds.has(addr.id);
      const Icon = iconForLabel(addr.label);
      return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("label", { className: `${SavedAddressPickerSheet_default.addrRow} ${checked ? SavedAddressPickerSheet_default.addrRowChecked : ""}`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: `${SavedAddressPickerSheet_default.checkbox} ${checked ? SavedAddressPickerSheet_default.checkboxChecked : ""}`, children: checked ? "\u2713" : "" }),
        /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: `${SavedAddressPickerSheet_default.iconWrap} ${checked ? SavedAddressPickerSheet_default.iconWrapChecked : ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Icon, { size: 16 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: SavedAddressPickerSheet_default.addrBody, children: [
          /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: SavedAddressPickerSheet_default.addrLabel, children: addr.label }),
          /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: SavedAddressPickerSheet_default.addrText, children: addr.address })
        ] })
      ] }, addr.id);
    }) }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: SavedAddressPickerSheet_default.footer, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("button", { type: "button", onClick: handleConfirm, disabled: count === 0, className: SavedAddressPickerSheet_default.confirmBtn, children: [
      count === 0 ? "Select addresses" : `Add ${count} address${count === 1 ? "" : "es"}`,
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(ArrowRight, { size: 15 })
    ] }) })
  ] }) });
}
...
async function sendChromeAi(messages) {
  ...
  const text7 = await s.prompt(last.content);
  return { text: text7.trim(), provider: "chrome-ai" };
}
...
function notify2(status, progress) {
  currentStatus = status;
  listeners3.forEach((listener) => listener(status, progress));
}
...
var mdComponents = {
  p: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { children }),
  h1: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { style: { fontWeight: 700, fontSize: "1.1em", margin: "8px 0 4px" }, children }),
  h2: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { style: { fontWeight: 700, fontSize: "1.05em", margin: "8px 0 4px" }, children }),
  h3: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { style: { fontWeight: 600, margin: "6px 0 2px" }, children }),
  h4: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { style: { fontWeight: 600, margin: "4px 0 2px" }, children }),
  hr: () => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("hr", { style: { border: "none", borderTop: "1px solid var(--color-border)", margin: "8px 0" } }),
  ul: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("ul", { style: { margin: "6px 0", paddingLeft: 18 }, children }),
  ol: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("ol", { style: { margin: "6px 0", paddingLeft: 18 }, children }),
  li: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("li", { children }),
  strong: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("strong", { children }),
  code: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("code", { style: { padding: "1px 4px", borderRadius: 4, fontSize: "0.8em", overflowWrap: "break-word", whiteSpace: "pre-wrap", wordBreak: "break-word" }, children }),
  pre: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("pre", { style: { margin: "6px 0", padding: "10px 12px", borderRadius: 8, border: "1px solid var(--color-border)", overflowX: "auto", whiteSpace: "pre-wrap", wordBreak: "break-word", maxWidth: "100%", background: "#000", color: "#fff" }, children }),
  a: ({ href, children }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("a", { href, target: "_blank", rel: "noopener noreferrer", style: { color: "var(--color-accent)", textDecoration: "underline", cursor: "pointer" }, children })
};
function ToolCallCards({ toolCalls }) {
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_jsx_runtime19.Fragment, { children: toolCalls.map((tc) => {
    if (!tc.result) return null;
    if (tc.toolName.endsWith("compare_routes")) {
      try {
        return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(RouteComparisonCard, { result: JSON.parse(tc.result) }, tc.toolCallId);
      } catch {
        return null;
      }
    }
    if (tc.toolName.endsWith("get_calendar_events")) {
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CalendarSummaryCard, { result: tc.result }, tc.toolCallId);
    }
    if (tc.toolName.endsWith("find_nearby_transport_hubs")) {
      const args = tc.args;
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(TransportHubsCard, { result: tc.result, location: args.location ?? "" }, tc.toolCallId);
    }
    if (tc.toolName.endsWith("search_web") || tc.toolName === "WebSearch") {
      const args = tc.args;
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CollapsibleToolCard, { icon: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { children: "\u{1F50D}" }), title: "Web Search", subtitle: args.query ?? "", children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(WebSearchCard, { result: tc.result, query: args.query ?? "", toolName: tc.toolName }) }, tc.toolCallId);
    }
    if ([...TASK_TOOL_NAMES].some((n) => tc.toolName.endsWith(n))) {
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(TaskCard, { result: tc.result, toolName: tc.toolName }, tc.toolCallId);
    }
    if (tc.toolName.endsWith("propose_calendar_event")) {
      const args = tc.args;
      if (!args.title || !args.start || !args.end) return null;
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CalendarEventProposalCard, { args }, tc.toolCallId);
    }
    return null;
  }) });
}
function FloatingAssistant({ onFlagTask, onUnflagTask, onScheduleTask, onAgentAction }) {
  ...
  const [text7, setText] = (0, import_react10.useState)("");
  ...
  const [activeSessionId, setActiveSessionId] = (0, import_react10.useState)(null);
  const [chips, setChips] = (0, import_react10.useState)([]);
  const [skill, setSkill] = (0, import_react10.useState)("general");
  const [showEventPicker, setShowEventPicker] = (0, import_react10.useState)(false);
  const [showAddressPicker, setShowAddressPicker] = (0, import_react10.useState)(false);
  const inputRef = (0, import_react10.useRef)(null);
  const bodyRef = (0, import_react10.useRef)(null);
  const sessionIdRef = (0, import_react10.useRef)(null);
  const msgIndexRef = (0, import_react10.useRef)(0);
  const pendingChatRef = (0, import_react10.useRef)(/* @__PURE__ */ new Map());
  const loadSession = (0, import_react10.useCallback)(async (sessionId) => {
  ...
  (0, import_react10.useEffect)(() => {
    ...
    loadAndRestorePlanningChat().then(() => idbListChatSessions()).then(async (all2) => {
      setSessions(all2);
      if (all2.length === 0) return;
      await loadSession(all2[0].id);
    }).catch(() => {
    });
  }, [open, loadSession]);
  (0, import_react10.useEffect)(() => {
  ...
  (0, import_react10.useEffect)(() => {
    ...
    const onMessage = (event) => {
      ...
      if (!pending) return;
      const updateAssistant = (content3, toolCalls) => {
        setMessages((previous3) => {
          const index2 = previous3.findIndex((message) => message.ts === pending.sendTs + 1);
          if (index2 < 0) return [...previous3, { role: "assistant", content: content3, ts: pending.sendTs + 1, toolCalls }];
          const next = [...previous3];
          next[index2] = { ...next[index2], content: content3, toolCalls: toolCalls ?? next[index2].toolCalls };
          return next;
        });
      };
      ...
      if (update.type === "CHAT_404" || update.type === "CHAT_UPDATE" && update.status === "failed") {
        ...
        setMessages((previous3) => previous3.map(
  ...
  const handleSend = async (retryRequest) => {
    const msg = (retryRequest?.message ?? text7).trim();
    ...
    const recordFailure = async (content3) => {
      ...
      if (sessionIdRef.current) {
        ...
        msgIndexRef.current += 1;
        try {
          await idbWriteChatMessage(sessionIdRef.current, assistantIndex, "assistant", content3, void 0, "failed");
        } catch {
        }
      }
      setMessages((prev) => [...prev, { role: "assistant", content: content3, ts: failedAt }]);
    };
...
${lines.join("\n")}]`;
  ...
  const [transcribing, setTranscribing] = (0, import_react10.useState)(false);
  const [micStatus, setMicStatus] = (0, import_react10.useState)(null);
  const recognitionRef = (0, import_react10.useRef)(null);
  const localRecordingRef = (0, import_react10.useRef)(null);
  ...
  const appendTranscript = (0, import_react10.useCallback)((transcript) => {
    if (transcript) setText((prev) => prev ? `${prev} ${transcript}` : transcript);
  }, []);
  const stopLocalDictation = (0, import_react10.useCallback)(async () => {
  ...
  const startLocalDictation = (0, import_react10.useCallback)(async () => {
    try {
  ...
  const startNativeDictation = (0, import_react10.useCallback)(() => {
    const w = window;
  ...
  const handleMic = (0, import_react10.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", "aria-label": `Open ${agentName} assistant`, onClick: () => {
      setOpen((v) => {
        if (v) {
    ...
    }, className: FloatingPanel_default.fab, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("img", { src: agentIcon ?? "/trippy-transparent.png", alt: agentName, className: FloatingPanel_default.headerIcon }) }),
    open && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.panel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.header, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.headerActions, children: [
            !showHistory && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", "aria-label": "New chat", onClick: () => {
              setMessages([]);
              setChips([]);
              sessionIdRef.current = null;
              msgIndexRef.current = 0;
              setActiveSessionId(null);
            }, className: FloatingPanel_default.iconBtn, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(SquarePen, { size: 16 }) }),
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", "aria-label": "Close", onClick: () => setOpen(false), className: FloatingPanel_default.iconBtn, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(X, { size: 16 }) })
          ] })
        ] }),
        showHistory ? /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.sessionList, children: [
          sessions.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { style: { fontSize: "var(--font-size-sm)", color: "var(--color-text-muted)", textAlign: "center", marginTop: 16 }, children: "No past conversations yet." }),
          sessions.length > 0 && (() => {
            ...
            return Object.entries(groups).map(([skillKey, group]) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_react10.default.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.sessionGroupLabel, children: SKILL_LABELS[skillKey] ?? skillKey }),
              group.map((s) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4, width: "100%", minWidth: 0 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("button", { type: "button", className: `${FloatingPanel_default.sessionRow} ${s.id === activeSessionId ? FloatingPanel_default.sessionRowActive : ""}`, style: { flex: 1, minWidth: 0 }, onClick: async () => {
                  const ok3 = await loadSession(s.id);
                  if (ok3) setShowHistory(false);
                }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.sessionTitle, children: s.title ? s.title.length > 60 ? s.title.slice(0, 60) + "\u2026" : s.title : "Untitled conversation" }),
                  /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.sessionDate, children: new Date(s.createdAt).toLocaleDateString(void 0, { month: "short", day: "numeric", year: "numeric" }) })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Trash2, { size: 13 })
                  }
                )
              ] }, s.id))
            ] }, skillKey));
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.body, ref: bodyRef, children: [
            messages.length === 0 && !sending && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: FloatingPanel_default.emptyState, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.skillPicker, children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.skillEmoji, children: "\u{1F4AC}" }),
                    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { children: "Tutorial" })
                  ]
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: FloatingPanel_default.skillDivider, children: "choose an agent" }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.skillEmoji, children: "\u{1F4CB}" }),
                    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { children: "Executive Assistant" })
                  ]
                }
              )
            ] }) }),
            messages.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.messageGroup, children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: m.role === "user" ? FloatingPanel_default.userBubble : FloatingPanel_default.responseBubble, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Markdown, { remarkPlugins: [remarkGfm], components: mdComponents, children: m.content }) }),
              m.role === "assistant" && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.assistantActions, children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: FloatingPanel_default.messageActionButtons, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
                  ReadAloudButton,
                  {
                    text: m.content,
                ...
                m.ts && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.msgTs, children: new Date(m.ts).toLocaleString(void 0, { month: "short", day: "numeric", hour: "numeric", minute: "2-digit" }) })
              ] }),
              m.role === "assistant" && m.toolCalls && m.toolCalls.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ToolCallCards, { toolCalls: m.toolCalls }),
              m.role === "user" && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.userMessageActions, children: [
                m.retryRequest && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("button", { type: "button", onClick: () => void handleSend(m.retryRequest), disabled: sending, className: FloatingPanel_default.retryBtn, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(RotateCcw, { size: 13 }),
                  " Retry"
                ] }),
                m.ts && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.msgTsUser, children: new Date(m.ts).toLocaleString(void 0, { month: "short", day: "numeric", hour: "numeric", minute: "2-digit" }) })
              ] })
            ] }, i)),
            sending && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.thinking, children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: FloatingPanel_default.dot }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: FloatingPanel_default.dot }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: FloatingPanel_default.dot })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.composer, children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.inputWrap, children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: FloatingPanel_default.chipRow, children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
                  ComposerPlusMenu,
                  {
                ...
                chips.map((c) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ContextChip, { chip: c, onRemove: () => setChips((prev) => prev.filter((p) => p.id !== c.id)) }, c.id))
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
                "textarea",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", "aria-label": transcribing ? "Transcribing voice input" : listening ? "Stop listening" : "Voice input", onClick: handleMic, disabled: transcribing, className: FloatingPanel_default.inlineIconBtn, children: transcribing || listening ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(MicOff, { size: 24 }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Mic, { size: 24 }) }),
              micStatus && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: FloatingPanel_default.speechStatus, role: "status", children: micStatus })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "0.2rem" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", "aria-label": "Send", onClick: handleSend, disabled: !text7.trim() || sending, className: FloatingPanel_default.sendBtn, children: sending ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { width: 14, height: 14, borderRadius: "50%", border: "2px solid rgba(255,255,255,0.4)", borderTopColor: "#fff", animation: "spin 0.6s linear infinite", display: "block" } }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ArrowUp, { size: 16 }) }),
              skill === "general" && text7.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { style: { fontSize: "0.65rem", color: text7.length >= 180 ? "var(--color-error, #e55)" : "var(--color-text-muted)" }, children: [
                text7.length,
                "/200"
              ] })
            ] })
