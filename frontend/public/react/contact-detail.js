...
function ContactNotes({ contact, onPatch }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CollapsiblePanel, { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(StickyNote, { size: 16, style: { color: "var(--color-accent)" } }), title: "Private Notes", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "textarea",
    {
      value: notes,
...
function ContactOutreach({ contact }) {
  ...
  const handleDraft = (0, import_react2.useCallback)(async () => {
    setLoading(true);
    setError(null);
    setStatus("Drafting\u2026");
    setMessage("");
  ...
  const actions = /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "button",
    {
      type: "button",
      ...
      disabled: loading,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TrippyIcon, { size: 13 }),
        loading ? status || "Drafting\u2026" : message ? "Redraft" : "Draft Message"
      ]
    }
  );
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(CollapsiblePanel, { icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Send, { size: 16, style: { color: "var(--color-accent)" } }), title: "Outreach Message", actions, children: [
    error && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: panel_default.errorText, children: error }),
    !message && !loading && !error && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: panel_default.emptyText, children: [
      'Click "Draft Message" to generate a personalised outreach message for ',
      contact.name,
      "."
    ] }),
    loading && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: panel_default.statusMsg, children: status || "Drafting\u2026" }),
    message && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { display: "flex", gap: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: `${Button_default.btn} ${Button_default.ghost} ${Button_default.sm}`, onClick: handleCopy, children: [
        copied ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CheckCheck, { size: 13 }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Copy, { size: 13 }),
        copied ? "Copied!" : "Copy"
      ] }) })
    ] })
  ] });
...
function ContactPrep({ contact }) {
  const [prep, setPrep] = (0, import_react3.useState)("");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(CollapsiblePanel, { icon: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Lightbulb, { size: 16, style: { color: "var(--color-accent)" } }), title: "Conversation Prep", actions, children: [
    error && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: panel_default.errorText, children: error }),
    !prep && !loading && !error && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { className: panel_default.emptyText, children: [
      'Click "Generate Prep" to get talking points, questions to ask, and what to share with ',
      contact.name,
      "."
    ] }),
    loading && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: panel_default.statusMsg, children: status || "Generating\u2026" }),
    prep && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { fontSize: "var(--font-size-sm)", lineHeight: 1.6, color: "var(--color-text)" }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      Markdown,
      {
        remarkPlugins: [remarkGfm],
        components: {
          h2: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h2", { style: { fontSize: "var(--font-size-sm)", fontWeight: 700, margin: "16px 0 6px", color: "var(--color-text)" }, children }),
          ul: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("ul", { style: { margin: "4px 0 12px", paddingLeft: 18 }, children }),
          li: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("li", { style: { marginBottom: 4 }, children }),
...
function ContactInfo({ contact, onPatch }) {
  const [email, setEmail] = (0, import_react4.useState)(contact.email ?? "");
  const [phone, setPhone] = (0, import_react4.useState)(contact.phone ?? "");
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "12px", padding: "16px 0" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: { fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--color-text-muted)", margin: 0 }, children: "Contact Info" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "6px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: { fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--color-text-muted)", margin: 0 }, children: "Preferred channel" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { display: "flex", gap: "8px" }, children: CHANNELS.map(({ value, label }) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "button",
        {
          type: "button",
...
function InteractionLog({
  ...
  const [date, setDate] = (0, import_react4.useState)(localDateTimeString());
  const [notes, setNotes] = (0, import_react4.useState)("");
  const notesRef = (0, import_react4.useRef)(null);
  const handleAdd = () => {
    if (!date) return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "10px", padding: "16px 0", borderTop: "1px solid var(--color-border)" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: { fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--color-text-muted)", margin: 0 }, children: "Interactions" }),
      !adding && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "button",
        {
          type: "button",
    ...
    adding && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "8px", padding: "12px", borderRadius: "var(--radius-md)", background: "var(--color-surface-raised)", border: "1px solid var(--color-border)" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "input",
        {
          className: Input_default.input,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: "8px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: `${Button_default.btn} ${Button_default.primary} ${Button_default.sm}`, onClick: handleAdd, disabled: !date, children: "Save" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: `${Button_default.btn} ${Button_default.ghost} ${Button_default.sm}`, onClick: () => setAdding(false), children: "Cancel" })
      ] })
    ] }),
    sorted.length === 0 && !adding && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: { fontSize: "12px", color: "var(--color-text-muted)", margin: 0 }, children: "No interactions logged yet." }),
    sorted.map((ix) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: "10px", alignItems: "flex-start" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Clock, { size: 12, style: { color: "var(--color-text-muted)", marginTop: 2, flexShrink: 0 } }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "2px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: { fontSize: "11px", fontWeight: 600, color: "var(--color-text)", margin: 0 }, children: formatInteractionDate(ix.date) }),
        ix.notes && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: { fontSize: "12px", color: "var(--color-text-muted)", margin: 0 }, children: ix.notes })
      ] })
    ] }, ix.id))
  ] });
}
function ContactDetailPage({ contactId }) {
  ...
  const [contact, setContact] = (0, import_react4.useState)(null);
  const [loading, setLoading] = (0, import_react4.useState)(true);
  const [notFound, setNotFound] = (0, import_react4.useState)(false);
  const [pendingStatus, setPendingStatus] = (0, import_react4.useState)(null);
  ...
  const patchRaw = (0, import_react4.useCallback)((body) => {
  ...
  const patch = (0, import_react4.useCallback)((update) => {
    setContact((prev) => prev ? { ...prev, ...update } : prev);
    patchRaw(update);
  }, [patchRaw]);
  const handleStatusChange = (0, import_react4.useCallback)((status) => {
    setPendingStatus({ status, date: localDateTimeString() });
  }, []);
  const confirmStatusChange = (0, import_react4.useCallback)(() => {
  ...
  const handleAddInteraction = (0, import_react4.useCallback)((ix) => {
  ...
  if (loading) return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: JobDetailPage_default.loading, children: "Loading\u2026" });
  if (notFound || !contact) return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: JobDetailPage_default.loading, children: "Contact not found." });
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: JobDetailPage_default.page, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: JobDetailPage_default.stickyTop, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ContactHeader, { contact }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ContactStatusBar, { status: contact.status, onStatusChange: handleStatusChange }),
      pendingStatus && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px", padding: "10px 16px", background: "var(--color-surface-raised)", borderBottom: "1px solid var(--color-border)" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: "12px", color: "var(--color-text-muted)", flexShrink: 0 }, children: "When did this happen?" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "input",
          {
            className: Input_default.input,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: `${Button_default.btn} ${Button_default.primary} ${Button_default.sm}`, onClick: confirmStatusChange, children: "Save" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: `${Button_default.btn} ${Button_default.ghost} ${Button_default.sm}`, onClick: () => setPendingStatus(null), children: "Cancel" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: JobDetailPage_default.grid, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: JobDetailPage_default.left, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ContactOutreach, { contact }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ContactPrep, { contact })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: JobDetailPage_default.right, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ContactInfo, { contact, onPatch: patch }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ContactNotes, { contact, onPatch: patch }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(InteractionLog, { interactions: contact.interactions ?? [], onAdd: handleAddInteraction }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: JobDetailPage_default.dangerZone, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
          "button",
          {
            type: "button",
...
async function mount() {
  ...
  (0, import_client.createRoot)(document.getElementById("react-root")).render(
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(AppHeader, { userImage: u.picture ?? "", userName: name, initials, pageTitle: "Contact" }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ContactDetailPage, { contactId })
    ] })
  );
}
void mount();
